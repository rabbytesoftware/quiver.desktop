// Every HTTP call the app makes, over the `quiver://` scheme the Rust proxy
...
const quiver = (window as unknown as { __QUIVER__?: { api?: string } }).__QUIVER__;

export const API_BASE: string = quiver?.api ?? 'quiver://localhost';

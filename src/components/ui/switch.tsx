...
function Switch({
	...
	return (
		<SwitchPrimitive.Root
			...
			data-size={size}
			className={cn(
				// `rounded-full` on BOTH, and not from the --radius scale: a switch
				// is a pill at every radius a design might pick, and this one had
				// its rounding stripped when the app was pinned at --radius: 0. Left
				// off, the track is a 32x18 rectangle sliding a square — which reads
				// as an unstyled checkbox rather than a switch.
